...
class ErrorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create error" do
    assert_difference("Error.count") do
      post errors_url, params: { error: { description: @error.description, severity: @error.severity, type: @error.error_type } }
    end
  ...
  test "should update error" do
    patch error_url(@error), params: { error: { description: @error.description, severity: @error.severity, type: @error.error_type } }
